...
** =
   ojo con el igual, que hace que apunte al mismo lugar de direcci'on
   ...
   Solucion -> usar el m'etodo arreglo.copy()
*** ej
    import numpy as np
    a = np.array(([1, 2, 3]))
...
** size/shape 
   ...
   print(np.shape(x))
** stadistics
   desviacion standard, (sigma): indica dispersion de los resultados 
...
**** ex1
     # intercamba los valores de una con la otra, si se quieren intercambiar las 
     # columnas enteras
     import pandas as pd
