...
🧠 R&D Engineer | 💻 CFD & Simulation

🧠 Physics-based simulation expert | CFD, Multiphysics & thermal systems | OpenFOAM
💻 Python/C++ | Numerical modeling | Advanced software development | Optimization
💡 Bridging rigorous scientific research with practical, results-driven solutions for industry
🎯 Committed to reliability, performance, and efficiency

Anterior expresando los emojis en hexadecimales
